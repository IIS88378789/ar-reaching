  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Aircraft in hangar - Professional aviation technology solutions"
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="inline-block mb-4 px-4 py-2 rounded-full glass-effect animate-fade-in">
          <span className="text-sm font-semibold text-accent animate-shimmer bg-clip-text">
            ✦ 次世代航空科技 ✦
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button 
            size="lg" 
            variant="outline" 
            className="text-lg glass-effect text-primary-foreground border-accent/50 hover:border-accent hover:shadow-glow-sm transition-all duration-300"
          >
            聯絡我們
          </Button>
        </div>
